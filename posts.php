<?php include 'includes/header.php' ?>
    ...
    <div class="blog-masthead">
      <div class="container">
        <nav class="blog-nav">
          ...
          <a class="blog-nav-item active" href="post.php">New posts</a>
    ...
    <!--   <div class="logo">
        <img src="images/rlogo.png" height="90" width="90">
      </div> -->
        <h1 class="blog-title">Post Number Uno</h1>
        <p class="lead blog-description">Sample post number at the Rutgers blog </p>
      </div>
